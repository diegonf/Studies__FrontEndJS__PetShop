...
const mensagensDeErro = {
  ...
  senha: {
    ...
    patternMismatch: 'A senha deve conter entre 6 e 12 caracteres, pelo menos uma letra minuscula, uma maiuscula e um numero e não deve conter simbolos.'
  },
  dataNascimento: {
...
function maiorQue18(data) {
  const dataAtual = new Date(); //coloca automatico a data de hoje
